...
{
    public abstract class MockEcommerceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MockEcommerceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MockEcommerceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MockEcommerceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MockEcommerceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MockEcommerceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MockEcommerceDbContext, Task<T>> func)
        {
            T result;
